 ...
 * vfs.c
 *
 * vfs.c -- Defines the interface for and structures relating to the virtual
 *file
...
struct f_ops f_ops_tab[DEV_SIZE] = {
    {tty_read, tty_write, NULL /*tty_open*/, NULL /*tty_close*/, NULL, NULL},
    {rlfs3_read, rlfs3_write, rlfs3_open, rlfs3_close, rlfs3_readdir,
     rlfs3_finddir}};
