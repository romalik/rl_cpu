...
lcc -Wo"-kernel" -I./ ./tty.c ./rlfs3.c ./blk.c  ./mm.c ./kernel_worker.c ./fork.c ./syscall.o ./exit.c ./kstdio.c ./sched.c ./sys.c ./string.c ./interrupts.o ./kernel_main.c ./malloc.c ./ata.c ./sh.c -o image
