...
lcc -Wo"-kernel" -I./ ./rlfs2.c ./blk.c ./vfs.c ./mm.c ./kernel_worker.c ./fork.c ./syscall.o ./exit.c ./stdio.c ./sched.c ./sys.c ./string.c ./interrupts.o ./kernel_main.c ./malloc.c ./ata.c ./sh.c -o image
