...
unsigned int vfs_read(struct vfs_node *node, off_t offset, size_t size, unsigned int *buf);
unsigned int vfs_write(struct vfs_node *node, off_t offset, size_t size, unsigned int *buf);
