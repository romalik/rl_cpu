...
int *line_ptr = 0;
int line[64*4];			/* Buffer for building output line */
int cur_font = 0x100;		/* Current font, 1 == Roman */

char line_header[64*4] = "";	/* Page header line */
char line_footer[64*4] = "";	/* Page footer line */
char little_header[64*4] = "";	/* Mini header for tty mode */
